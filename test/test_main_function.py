...
class TestStellarBurgersMainFunction:
    ...
    def test_order_feed_button_click(self, driver, pages):
    ...
    def test_design_button_click(self, driver, pages):
    ...
    def test_ingredient_pop_up(self, driver, pages):
    ...
    def test_ingredient_pop_up_close(self, driver, pages):
        pages.click_bun_picture()
    ...
    def test_add_ingredient_to_basket(self, driver, pages):
